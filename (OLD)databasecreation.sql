...
(1, 100, 75, 55, 65, 0, '2024-01-10'),
(2, 101, 80, 60, 70, 0, '2024-02-04'),
(3, 102, 85, 65, 75, 10, '2023-08-19'),
(4, 103, 70, 50, 60, 5, '2023-09-20'),
(5, 104, 60, 40, 50, 8, '2023-10-19'),
(1, 105, 75, 55, 65, 15, '2023-11-19'),
(2, 106, 80, 60, 70, 5, '2023-12-20'),
(3, 107, 45, 25, 35, 20, '2024-01-19'),
(4, 108, 65, 45, 55, 10, '2024-02-18'),
(5, 109, 85, 65, 75, 5, '2024-03-21'),
(1, 110, 70, 50, 60, 10, '2023-04-19'),
(2, 111, 60, 40, 50, 8, '2023-05-20'),
(3, 112, 55, 35, 45, 12, '2023-06-19'),
(4, 113, 80, 60, 70, 6, '2023-07-18'),
(5, 114, 75, 55, 65, 10, '2023-08-21'),
(1, 115, 90, 70, 80, 5, '2023-09-20'),
(2, 116, 65, 45, 55, 15, '2023-10-19'),
(3, 117, 50, 30, 40, 18, '2023-11-20'),
(4, 118, 75, 55, 65, 8, '2023-12-19'),
(5, 119, 70, 50, 60, 12, '2023-01-18'),
(1, 120, 85, 65, 75, 7, '2023-02-21'),
(2, 121, 60, 40, 50, 20, '2023-03-20'),
(3, 122, 55, 35, 45, 15, '2023-04-19');


INSERT INTO HealthReview ([UID], LID, WID, Rating, Comment, [Date]) VALUES
(6, 1, 105, 4, 'Enjoyed the city vibe!', '2023-11-19'),
(7, 2, 106, 8, 'Perfect weather for outdoor activities.', '2023-12-20'),
(8, 3, 107, 2, 'Too cold for my liking.', '2024-01-19'),
(9, 4, 108, 7, 'Nice and mild, great for exploring.', '2024-02-18'),
(10, 5, 109, 9, 'Absolutely beautiful weather!', '2024-04-04'),
(11, 1, 110, 6, 'A bit chilly but manageable.', '2024-04-11'),
(12, 2, 111, 7, 'Lovely weather, perfect for a stroll.', '2024-04-04'),
(13, 3, 112, 5, 'Slightly cool, but enjoyable overall.', '2024-04-03'),
(14, 4, 113, 8, 'Great weather for outdoor activities.', '2024-04-02'),
(15, 5, 114, 6, 'Pleasant temperature, slight breeze.', '2024-04-04'),
(16, 1, 115, 9, 'Warm and sunny, perfect beach day!', '2024-04-04'),
(17, 2, 116, 5, 'Bit rainy, but still had fun.', '2024-04-11'),
(18, 3, 117, 3, 'Cold and rainy, not ideal.', '2024-04-04'),
(19, 4, 118, 7, 'Nice weather, good for sightseeing.', '2024-04-04'),
(20, 5, 119, 8, 'Enjoyed the pleasant weather.', '2024-04-04'),
(21, 1, 120, 9, 'Perfect temperature, sunny skies.', '2024-04-04'),
(22, 2, 121, 4, 'Too much rain, couldnt do much outdoors.', '2024-04-04'),
(23, 3, 122, 5, 'Cool weather, could use a jacket.', '2024-04-04'),
(24, 1, 105, 7, 'Warm weather, great for outdoor activities.', '2024-04-04'),
(25, 2, 106, 8, 'Sunny and warm, perfect day for a picnic.', '2024-04-04');
